    ...
    <body>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a style="color: #ff6633" href="viewPlaces.jsp">View Places</a></li>
        ...
        <main id="main">
            ...
            <section id="about" class="about">
                <div class="container" data-aos="fade-up">
                    <center><h2>All Places</h2></center><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="customers">
                                ...
                                %>
                                <tr>
                                    <td><center><img src="location_img?id=<%=rs.getString("id")%>" width="300" height="300"/></center></td>
