...
<html lang="en">
    ...
    <%
        if (request.getParameter("Rating_added") != null) {
    %>
    <script>alert('Rating Added Successfully');</script>
    <%            }
    %>
    <body>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a style="color: #ff6633" href="rating.jsp">Give Rating</a></li>
        ...
        <main id="main">
            ...
            <section id="contact" class="contact">
                <div class="container" data-aos="fade-up">                        
                    <center><h3>Give Rating</h3></center><br>
                    <div class="row mt-5">
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <img src="assets/img/rating.jpg" width="450" height="400" />
                        </div>
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <form action="giveRating.jsp" method="post" role="form">
                                ...
                                <div class="form-group">
                                    <label>Rating :</label>
                                    <input type="number" class="form-control" min="1" max="5" name="rating" placeholder="Enter Your Rating" required="" />
                                </div>
                                <div class="form-group">
