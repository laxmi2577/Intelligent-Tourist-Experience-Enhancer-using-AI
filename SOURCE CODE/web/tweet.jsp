    ...
    <body>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a style="color: #ff6633" href="tweet.jsp">Tweet</a></li>
        ...
        <main id="main">
            ...
            <section id="contact" class="contact">
                <div class="container" data-aos="fade-up">                        
                    <center><h3>Post Tweet</h3></center><br>
                    <div class="row mt-5">
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <img src="assets/img/tweet.jpg" width="450" height="400" />
                        </div>
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <form action="Tweets" method="post" enctype="multipart/form-data" role="form">
                                <div class="form-group">
                                    <label>Post Tweet :</label>
                                    <textarea name="msg" class="form-control" style="height: 100px;color: black;" placeholder="Type Tweet Here!" required="required"></textarea><br>
                                </div>
                                <div class="form-group">
