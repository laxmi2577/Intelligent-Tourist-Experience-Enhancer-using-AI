                ...
                <div class="container" data-aos="fade-up">                        
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <img src="assets/img/cta-bg.jpg" width="450" height="400" />
                        </div>
                        <%
                            ...
                            session.setAttribute("sfid", fid);
                            session.setAttribute("sfname", fname);


                        %>
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <form action="Msg" method="post" enctype="multipart/form-data" role="form">
                                <div class="form-group">
                                    <label>Enter Message :</label>
                                    <textarea name="msg" class="form-control" style="height: 100px;color: black;" placeholder="Type Message Here!" required="required"></textarea><br>
                                </div>
                                <div class="form-group">
