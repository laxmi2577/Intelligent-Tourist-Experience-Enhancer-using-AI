    ...
    <body>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a style="color: #ff6633" href="followers.jsp">Followers</a></li>
        ...
        <main id="main">
            ...
            <section id="about" class="about">
                <div class="container" data-aos="fade-up">
                    <center><h2>Followers</h2></center><br>
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <tr>
                                    <%
                                        ...
                                        try {
                                            ...
                                            while (rs5.next()) {
                                    %>
                                    <td><center><%=rs5.getString("uid")%></center></td>   
                                <td><center><%=rs5.getString("name")%></center></td>  
                                <td><center><img src="Getimage?id=<%=rs5.getString("uid")%>" width="120" height="100"><br><br><br></center></td>
                                </tr>
                                <%
                                        }
                                    } catch (Exception ex) {
